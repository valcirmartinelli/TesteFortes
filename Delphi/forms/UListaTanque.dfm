inherited FrmListaTanque: TFrmListaTanque
  Caption = ''
  ClientHeight = 515
  ClientWidth = 748
  ExplicitWidth = 766
  ...
  inherited PnlCima: TPanel
    ...
    inherited GbPesquisa: TGroupBox
      ...
      object BtPesqCombustivel: TSpeedButton [3]
        Left = 297
        Top = 29
        Width = 23
        Height = 23
        ...
        NumGlyphs = 2
        OnClick = BtPesqCombustivelClick
      end
      ...
      object EdCombustivel: TEdit
        ...
        NumbersOnly = True
        TabOrder = 3
        OnExit = EdCombustivelExit
      end
      object EdNomeCombustivel: TEdit
        Left = 326
        Top = 29
        Width = 327
        Height = 23
